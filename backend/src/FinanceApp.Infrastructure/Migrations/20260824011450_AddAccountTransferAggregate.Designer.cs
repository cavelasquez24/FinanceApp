...
namespace FinanceApp.Infrastructure.Migrations
{
    ...
    [Migration("20260824011450_AddAccountTransferAggregate")]
    partial class AddAccountTransferAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Debt", b =>
                {
                    ...
                    b.Property<Guid?>("LinkedSavingsGoalId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("LinkedSavingsGoalId")
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.SavingsGoalContribution", b =>
                {
                    ...
                    b.Property<Guid?>("SavingsReplenishmentId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SavingsReplenishmentId")
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.SavingsReplenishment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("AmountReplenished")
                        .HasColumnType("numeric(15,2)")
                        .HasColumnName("amount_replenished");
                    ...
                    b.Property<bool>("AutoDebitEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_debit_enabled");
                    ...
                    b.Property<DateOnly?>("LastDebitAt")
                        .HasColumnType("date")
                        .HasColumnName("last_debit_at");

                    b.Property<decimal>("MonthlyDebitAmount")
                        .HasColumnType("numeric(15,2)")
                        .HasColumnName("monthly_debit_amount");
                    ...
                    b.HasIndex("SavingsGoalId")
                        .HasDatabaseName("idx_savings_replenishments_goal_id");

                    b.HasIndex("SourceAccountId")
                        .HasDatabaseName("idx_savings_replenishments_source_account_id");

                    b.HasIndex("UserId", "Status")
                        .HasDatabaseName("idx_savings_replenishments_user_status")
                        .HasFilter("deleted_at IS NULL");

                    b.ToTable("savings_replenishments", (string)null);
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.SavingsGoalContribution", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Entities.SavingsReplenishment", "SavingsReplenishment")
                        .WithMany("Contributions")
                        .HasForeignKey("SavingsReplenishmentId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SavingsReplenishment");
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.SavingsReplenishment", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Entities.User", "User")
                        .WithMany("SavingsReplenishments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("SavingsReplenishments");
                });
